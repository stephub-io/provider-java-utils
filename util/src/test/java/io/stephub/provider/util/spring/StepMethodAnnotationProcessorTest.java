...
import io.stephub.provider.util.LocalProviderAdapter.SessionState;
...
import io.stephub.provider.util.spring.StepMethodAnnotationProcessor.StepArgument;
import io.stephub.provider.util.spring.StepMethodAnnotationProcessor.StepMethod;
...
class StepMethodAnnotationProcessorTest {
    ...
    public static class TestProvider extends SpringBeanProvider<SessionState<Object>, Object> {
        ...
        public StepResponse testStepMultipleArgs(final SessionState<Object> someState,
                                                 @StepArgument(name = "enabled") boolean arg1,
